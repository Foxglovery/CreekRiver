...
namespace CreekRiver.Migrations
{
    ...
    [Migration("20231228174700_InitialCreate")]
            ...
            modelBuilder.Entity("CreekRiver.Models.Reservation", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CampsiteId = 3,
                            CheckinDate = new DateTime(2024, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            CheckoutDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(2015),
                            UserProfileId = 1
                        });
                });
            ...
            modelBuilder.Entity("CreekRiver.Models.UserProfile", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Email = "iamtrappedhere@neopets.com",
                            FirstName = "Groogery",
                            LastName = "Adlerburb"
                        });
                });
